...
def visual_graphhml(graph):
    # Load the GraphML file
    # graph = nx.read_graphml('/Users/saillab/Shengting/graphrag-local-ollama/ragtest_nsduh/output/20240722-161311/artifacts/summarized_graph.graphml')
